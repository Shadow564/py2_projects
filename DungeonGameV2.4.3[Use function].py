...
door_2_2_8 = doors(2, 3, 2, 2, 8, 7, 2, 2, 0, 1, False)
...
#set up third room 33333333333333333333333333333333333333333333333333333
 #r03Layout
r03Layout = []
for x in range(0, 5):
  r03Layout.append(["#"] * 5)
...
r03Layout[4][2] = "D"
 #setup doors (self, r1, r2, r1y, rlyin, r1x, rlxin, r2y, r2yin, r2x, rxyin, islocked,)
door_3_2_0 = doors(3, 2, 2, 2, 0, 1, 2, 2, 8, 7, False)
door_3_2_4 = doors(3, 4, 2, 2, 4, 3, None, None, None, None, False)
door_3_4_2 = doors(3, 2, 4, 3, 2, 2, None, None, None, None, False)
r03Doors = [door_3_2_0, door_3_2_4, door_3_4_2]
 #setup Chests
chest_3_2_2 = chest(2, 2, 2, ["stones", "string"])
r03Chests = [chest_3_2_2]
 #setup Printing
def printR03(var):
  global r03Layout
  for row in r03Layout:
    print " ".join(row)
 #finalize room (self, layout, doorlist, chestlist, isloaded, yborder, xborder, comoprinter)
roomN3 = rooms(r03Layout, r03Doors, r03Chests, True, 5, 5, printR03)
allrooms.append(roomN3)
roomN3.layout[2][2] = "C"
...
def use(item):
  foods = {"carl's yummy fruit salad", 
...
while running >= 0 and death == False:
  ...
  if user_input == "e":
    ...
    print inv
    being_used = raw_input("What will you use?: ")
    use(being_used)
  else:
    move(user_input)
